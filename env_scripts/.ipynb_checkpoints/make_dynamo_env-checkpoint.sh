#!/bin/bash
#SBATCH --job-name=dyn_env
#SBATCH --output=dynamo-%j.out
...
# pip install --no-cache-dir -r ../basic_requirements.txt

pip install --upgrade pip
pip install --no-cache-dir dynamo-release==1.2.0
pip install --no-cache-dir scanpy==1.9.*
pip install --no-cache-dir scvelo==0.2.*
pip install --no-cache-dir anndata==0.8.0
pip install --no-cache-dir numpy==1.23.5
pip install --no-cache-dir matplotlib==3.6.3 
pip install --no-cache-dir pandas==1.5.3
pip install --no-cache-dir scipy==1.11.*
pip install --no-cache-dir scikit-learn==1.2.*
